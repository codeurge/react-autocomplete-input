...
class AutocompleteTextField extends React.Component {
	constructor(props) {
		...
		this.debouncedResetScroll = _.debounce(() => this.resetScrollLock(),250);
	...
	checkScroll() {
		this.scrollLock();
		let parentEl = document.getElementsByClassName('react-autocomplete-input');
		if (!parentEl.length) {
			return;
		}
		let el = parentEl[0].getElementsByClassName('active'),
